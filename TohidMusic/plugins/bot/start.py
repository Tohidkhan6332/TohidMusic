...
from TohidMusic import Telegram, YouTube, app
from TohidMusic.misc import SUDOERS
from TohidMusic.plugins.play.playlist import del_plist_msg
from TohidMusic.plugins.sudo.sudoers import sudoers_list
...
from TohidMusic.utils.decorators.language import LanguageStart
from TohidMusic.utils.inline import help_pannel, private_panel, start_pannel
from TohidMusic.utils.command import commandpro
...
@app.on_message(commandpro(["/alive", "Tohid"]))
async def alive(client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/125f531d44a9999290cac.jpg",
        caption=f"""━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ ʜᴇʟʟᴏ, ᴛᴏʜɪᴅ ɪs ᴡᴏʀᴋɪɴɢ ᴀɴᴅ ғᴜɴᴄᴛɪᴏɴɪɴɢ ᴘʀᴏᴘᴇʀʟʏ\n✪ ᴛʜᴀɴᴋs ᴛᴏ ᴛᴏʜɪᴅ ᴛᴇᴀᴍ 🌼 ..\n\n┏━━━━━━━━━━━━━━━━━┓\n┣★ ᴏᴡɴᴇʀ    : [ᴀsᴀᴅ ᴀʟɪ](https://t.me/Dr_Asad_Ali)\n┣★ ᴜᴘᴅᴀᴛᴇs › : [ᴀʟᴇxᴀ ʜᴇʟᴘ](https://t.me/Alexa_BotUpdates)┓\n┣★ ʀᴇᴘᴏ › : [ᴀʟᴇxᴀ ʀᴇᴘᴏ](https://github.com/Tohidkhan6332/TohidMusic)\n┗━━━━━━━━━━━━━━━━━┛\n\n💞 ɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴛʜᴇɴ\nᴅᴍ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](https://t.me/tohid_mewati) ᴍᴀᴋᴇ sᴜʀᴇ ᴛᴏ sᴛᴀʀ ᴏᴜʀ ᴘʀᴏᴊᴇᴄᴛ ...\n\n━━━━━━━━━━━━━━━━━━━━━━━━""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 ᴛᴏʜɪᴅ ᴄʜᴀᴛ 💮", url=config.SUPPORT_GROUP)]]
        ),
    )


@app.on_message(commandpro(["/verify", "tohidverification"]))
async def verify(client, message: Message):
    ...
    await message.reply_photo(
        ...
        caption=f"""━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ **ᴄᴏɴɢʀᴀᴛᴜʟᴀᴛɪᴏɴ** 🎉\n✪ ɴᴏᴡ ʏᴏᴜ ᴀʀᴇ ᴛᴏʜɪᴅ ᴠᴇʀɪғɪᴇᴅ ᴍᴇᴍʙᴇʀ ɢᴏ ʙᴀᴄᴋ ᴀɴᴅ ᴇɴᴊᴏʏ ᴏᴜʀ sᴇʀᴠɪᴄᴇ ᴀɴᴅ ᴘʟᴀʏ ᴍᴜsɪᴄ 🌼 ..\n\n━━━━━━━━━━━━━━━━━━━━━━━━""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 ᴛᴏʜɪᴅ ᴄʜᴀᴛ 💮", url=config.SUPPORT_GROUP)]]
        ),
    )
