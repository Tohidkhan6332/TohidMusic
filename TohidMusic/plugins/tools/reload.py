...
from TohidMusic.utils.database import get_authuser_names, get_cmode
from TohidMusic.utils.decorators import ActualAdminCB, AdminActual, language
from TohidMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Tohid.stop_stream(message.chat.id)
    except:
        pass
